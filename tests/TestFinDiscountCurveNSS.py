...
def test_FinNelsonSiegelSvenssonCurve():
    ...
    curve2 = TuringDiscountCurveNSS(startDate, 0., 1., 0., 0., tau1, tau2)
    factor2loading = curve2.zeroRate(dates)
    curve3 = TuringDiscountCurveNSS(startDate, 0., 0., 1., 0., tau1, tau2)
    factor3loading = curve3.zeroRate(dates)
    curve4 = TuringDiscountCurveNSS(startDate, 0., 0., 0., 1., tau1, tau2)
...
##########################################################################
    ...
    beta3 = -0.02
    beta4 = 0.08
    curve1 = TuringDiscountCurveNSS(startDate,
    ...
    beta3 = -0.02
    beta4 = 0.08
    curve2 = TuringDiscountCurveNSS(startDate,
                                    beta1, beta2, beta3, beta4, tau1, tau2)
    ...
    beta3 = -0.02
    beta4 = 0.08
    curve3 = TuringDiscountCurveNSS(startDate,
                                    beta1, beta2, beta3, beta4, tau1, tau2)
    ...
    beta3 = -0.02
    beta4 = 0.08
    curve4 = TuringDiscountCurveNSS(startDate,
                                    beta1, beta2, beta3, beta4, tau1, tau2)
    ...
    beta3 = -0.02
    beta4 = 0.08
    curve5 = TuringDiscountCurveNSS(startDate,
                                    beta1, beta2, beta3, beta4, tau1, tau2)
