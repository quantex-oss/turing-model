...
def test_FinNelsonSiegelCurve():
    ...
    curveDate = TuringDate(6, 6, 2019)
    dates = curveDate.addYears(times)

    curve1 = TuringDiscountCurveNS(curveDate, 1, 0, 0, tau)
    factor1loading = curve1.zeroRate(dates)
    curve2 = TuringDiscountCurveNS(curveDate, 0, 1, 0, tau)
    factor2loading = curve2.zeroRate(dates)
    curve3 = TuringDiscountCurveNS(curveDate, 0, 0, 1, tau)
    ...
    beta2 = -0.02
    beta3 = 0.02
    curve1 = TuringDiscountCurveNS(curveDate, beta1, beta2, beta3, tau)
    ...
    beta2 = -0.02
    beta3 = 0.02
    curve2 = TuringDiscountCurveNS(curveDate, beta1, beta2, beta3, tau)
    ...
    beta2 = -0.02
    beta3 = 0.02
    curve3 = TuringDiscountCurveNS(curveDate, beta1, beta2, beta3, tau)
    ...
    beta2 = -0.02
    beta3 = 0.02
    curve4 = TuringDiscountCurveNS(curveDate, beta1, beta2, beta3, tau)
    ...
    beta2 = -0.02
    beta3 = 0.02
    curve5 = TuringDiscountCurveNS(curveDate, beta1, beta2, beta3, tau)
