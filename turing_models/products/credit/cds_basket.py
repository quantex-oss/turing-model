...
from turing_models.models.model_gaussian_copula_1f import homogeneousBasketLossDbn
from turing_models.models.model_gaussian_copula import defaultTimesGC
from turing_models.models.model_student_t_copula import TuringModelStudentTCopula
...
###############################################################################
    ...
    def __repr__(self):
        ...
        s += to_string("STEP-IN DATE", self._stepInDate)
        s += to_string("MATURITY", self._maturityDate)
        s += to_string("NOTIONAL", self._notional)
        s += to_string("RUNNING COUPON", self._runningCoupon * 10000, "bp\n")
