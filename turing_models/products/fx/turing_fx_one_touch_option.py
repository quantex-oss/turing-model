...
from turing_models.models.turing_gbm_process import getPaths

from numba import njit

from turing_models.turingutils.turing_math import NVect
...
###############################################################################
    ...
    def value(self,
        ...
        if self._optionType == TuringTouchOptionPayoffTypes.DOWN_AND_IN_CASH_AT_HIT:
            ...
            if np.any(s0 <= H):
                raise TuringError("FX Rate is currently below barrier.")
            ...
            if np.any(s0 >= H):
                raise TuringError("FX Rate is currently above barrier.")
