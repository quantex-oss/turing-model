...
from turing_models.turingutils.turing_global_variables import gSmall
from turing_models.turingutils.turing_day_count import TuringDayCount, TuringDayCountTypes
from turing_models.turingutils.turing_frequency import TuringFrequencyTypes, TuringFrequency
from turing_models.turingutils.turing_calendar import TuringCalendarTypes,  TuringDateGenRuleTypes
from turing_models.turingutils.turing_calendar import TuringCalendar, TuringBusDayAdjustTypes
...
class TuringIborIborSwap(object):
    ...
    def __init__(self,
                 ...
                 payFreqType: TuringFrequencyTypes = TuringFrequencyTypes.QUARTERLY,
                 payDayCountType: TuringDayCountTypes  = TuringDayCountTypes.THIRTY_E_360,
                 recFreqType: TuringFrequencyTypes = TuringFrequencyTypes.QUARTERLY,
                 recDayCountType: TuringDayCountTypes = TuringDayCountTypes.THIRTY_E_360,
...
##########################################################################
    ...
    def _generatePayFloatLegPaymentDates(self, freqType):
        ...
        floatDates = TuringSchedule(self._effectiveDate,
