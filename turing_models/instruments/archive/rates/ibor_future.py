...
##########################################################################
    ...
    def __repr__(self):
        ...
        s += to_string("LAST TRADING DATE", self._lastTradingDate)
        s += to_string("DELIVERY DATE", self._deliveryDate)
        s += to_string("END INTEREST PERIOD", self._endOfInterestPeriod)
