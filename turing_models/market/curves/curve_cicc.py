...
class Shibor3M:
    ...
    def tweak_keytenor(self, tenor, tenor_type, tweak):
        if tenor_type.lower() == 'deposit':
            ...
            curve = self._build(deposit_mkt_data_tweaked, self.swap_mkt_data, self.today)
            ...
            curve = self._build(self.deposit_mkt_data, swap_mkt_data_tweaked, self.today)
    ...
    def tweak_parallel(self, tweak):
        ...
        curve = self._build(deposit_mkt_data_tweaked, swap_mkt_data_tweaked, self.today)
