...
from turing_models.models.model_rates_hw import TuringModelRatesHW, TuringHWEuropeanCalcType
...
def test_FinBondOptionEuropeanConvergence():
    ...
    maturityDate = TuringDate(2020, 12, 1)
    coupon = 0.05
    ...
    expiryDate = TuringDate(2020, 3, 1)
    strikePrice = 100.0
    face = 100.0
...
def test_FinBondOptionZEROVOLConvergence():
    ...
    # Build discount curve
    settlementDate = TuringDate(2019, 9, 1)
    rate = 0.05
    ...
    # Option Details
    expiryDate = TuringDate(2021, 12, 1)
    face = 100.0
