...
\lstset{language=Python, 
        ...
        frame=single,
        otherkeywords = {TuringDate, TuringCalendarTypes, TuringBusDayAdjustTypes, TuringDateGenRuleTypes, TuringDayCountTypes, TuringFrequencyTypes,
        FinLiborSwaptionTypes, FinOptionExerciseTypes, TuringOptionTypes, TuringEquityBarrierTypes, TuringEquityRainbowOptionTypes, List}
        }
