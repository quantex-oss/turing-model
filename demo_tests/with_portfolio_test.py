...
scenario_extreme = PricingContext(
    ...
    fx_implied_volatility_curve=[
        {"symbol": "USD/CNY", "value": {
            ...
            "25D BF": [0.003391, 0.00125, 0.00125, 0.00125, 0.00225, 0.00175, 0.00238, 0.00275, 0.003, 0.00325, 0.00362,
                       0.004, 0.004],
            "25D RR": [0.002304, 0.003, 0.003, 0.003, 0.00325, 0.0035, 0.005, 0.00525, 0.006, 0.00625, 0.006, 0.0065,
                       0.00875],
            "10D BF": [0.004842, 0.00175, 0.00175, 0.002, 0.003, 0.004, 0.0045, 0.0055, 0.007, 0.0085, 0.008, 0.008,
                       0.0085],
            "10D RR": [0.00303, 0.0045, 0.005, 0.0055, 0.006, 0.0065, 0.007, 0.0095, 0.0115, 0.014, 0.0125, 0.012,
                       0.013]
        }
         }
    ],
    ...
    shibor_curve={
        ...
        "origin_tenor": ["O/N", "1W", "2W", "1M", "3M", "6M", "9M", "1Y"],
        "rate": [0.02042, 0.02115, 0.02235, 0.023, 0.02353, 0.02472, 0.02656, 0.027]
    },
    fx_swap_curve=[
        {"symbol": "USD/CNY", "value": {
            "tenor": [0.003, 0.006, 0.009, 0.021, 0.042, 0.0625, 0.083, 0.17, 0.25, 0.334, 0.417, 0.5, 0.75, 1, 1.5, 2,
                      3, 4, 5],
            "origin_tenor": ["ON", "TN", "SN", "1W", "2W", "3W", "1M", "2M", "3M", "4M", "5M", "6M", "9M", "1Y", "18M",
                             "2Y", "3Y", "4Y", "5Y"],
            "swap_point": [0.001151, 0.000409, 0.000413, 0.00283, 0.00654, 0.0097, 0.01368, 0.02995, 0.0425, 0.0548,
                           0.069, 0.0848, 0.1215, 0.1583, 0.2307, 0.293, 0.393, 0.5, 0.605]
        }
         }
    ]
)
