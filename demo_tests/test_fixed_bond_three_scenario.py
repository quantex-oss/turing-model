...
print("1st scenerio:")
print("spread_adjustment", bond_fr1._spread_adjustment)
...
print("2nd scenerio:")
print("spread_adjustment", bond_fr2._spread_adjustment)
...
print("3rd scenerio:")
print("spread_adjustment", bond_fr3._spread_adjustment)
